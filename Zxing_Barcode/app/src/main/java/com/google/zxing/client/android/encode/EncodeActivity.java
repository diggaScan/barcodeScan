...
public final class EncodeActivity extends Activity {
  ...
  protected void onResume() {
    ...
    try {
      ...
      qrCodeEncoder = new QRCodeEncoder(this, data, smallerDimension,Contents.Type.TEXT);
      File file = new File(this.getExternalFilesDir(null), "/qrcode.png");
      Bitmap bitmap = qrCodeEncoder.encodeAsBitmap(file.getAbsolutePath());
      if (bitmap == null) {
